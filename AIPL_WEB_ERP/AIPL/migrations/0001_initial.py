# Generated by Django 4.0.6 on 2024-10-11 17:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ml_python', 'Machine Learning with Python'), ('ai', 'Artificial Intelligence'), ('cyber_security', 'Cyber Security'), ('fullstack_web', 'Full Stack Web Development'), ('android_dev', 'Android Development'), ('data_science_python', 'Data Science with PYTHON'), ('cloud_computing', 'Cloud Computing'), ('digital_marketing', 'Digital Marketing'), ('cw', 'Content Writer'), ('finance', 'Finance'), ('marketing', 'Marketing'), ('ios_dev', 'IOS App Development')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('job_role', models.CharField(choices=[('Frontend Dev', 'Frontend Dev'), ('Backend Dev', 'Backend Dev'), ('DevOps Eng', 'DevOps Eng'), ('Fullstack Dev', 'Fullstack Dev'), ('IOS Dev', 'IOS Dev'), ('Software Dev', 'Software Dev'), ('AI/ML Eng', 'AI/ML Eng'), ('Data Analyst', 'Data Analyst'), ('DB Admin', 'DB Admin'), ('Cloud Dev', 'Cloud Dev'), ('Blockchain Dev', 'Blockchain Dev'), ('AR/VR Dev', 'AR/VR Dev'), ('Test Automation', 'Test Automation'), ('BDA Trainee', 'BDA Trainee'), ('Content Writer', 'Content Writer'), ('Digital Marketing Trainee', 'Digital Marketing Trainee')], max_length=50)),
